...
| [ECK-CoronaMap](http://arcane-sierra-73158.herokuapp.com/) | TR, EN | Downloadable graphics in desired format for each country and situation, map with area and circle display and timer for the entire application (This application is for my thesis). | :earth_asia: | [Emin Can Kırmızı](http://arcane-sierra-73158.herokuapp.com/) :tr: | :x: | [covid-19-api](https://coronavirus-19-api.herokuapp.com/countries), [wuhan-coronavirus-api](https://wuhan-coronavirus-api.laeyoung.endpoint.ainize.ai/jhu-edu/timeseries) | :x: |
