...
| [Routitude COVID-19 Map, Dashboard, Travel Restrictions](https://www.routitude.com/map/covid) | EN | Real-time dashboard and interactive map with frequently updated COVID-19 data, historical tends and travel restrictions for each country | :earth_asia: | [Routitude](https://www.routitude.com/map/covid) | :x: | [JHU](https://systems.jhu.edu/research/public-health/ncov/), Wikipedia | :x: |
